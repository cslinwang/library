...
-- ----------------------------
-- Table structure for `jg`
-- ----------------------------
DROP TABLE IF EXISTS `jg`;
CREATE TABLE `jg` (
  `jg_id` int(11) NOT NULL AUTO_INCREMENT,
  `jg_name` varchar(255) DEFAULT NULL,
  `jg_reason` varchar(255) DEFAULT NULL,
  `jg_state` int(11) unsigned zerofill DEFAULT '00000000000',
  PRIMARY KEY (`jg_id`)
...
-- Records of jg
-- ----------------------------
INSERT INTO `jg` VALUES ('1', '1', '1', '00000000002');
INSERT INTO `jg` VALUES ('2', '1', '1', '00000000002');
INSERT INTO `jg` VALUES ('3', '11', '11', '00000000002');
INSERT INTO `jg` VALUES ('4', '111', '111', '00000000002');
INSERT INTO `jg` VALUES ('5', '1', '1', '00000000001');
INSERT INTO `jg` VALUES ('6', '1', '1', '00000000000');
INSERT INTO `jg` VALUES ('7', '1', '1', '00000000000');
INSERT INTO `jg` VALUES ('8', '11', '11', '00000000000');
INSERT INTO `jg` VALUES ('9', '1', '1', '00000000000');
INSERT INTO `jg` VALUES ('10', '深度学习', '非常好！！！！', '00000000000');
...
-- Records of job
-- ----------------------------
INSERT INTO `job` VALUES ('11', '11');
INSERT INTO `job` VALUES ('20170001', '111111');
...
CREATE TABLE `lend_list` (
  ...
  PRIMARY KEY (`sernum`)
) ENGINE=InnoDB AUTO_INCREMENT=2015040155 DEFAULT CHARSET=utf8;
...
INSERT INTO `lend_list` VALUES ('2015040146', '10000001', '11', '2017-12-10', '2017-12-10');
INSERT INTO `lend_list` VALUES ('2015040147', '10000001', '11', '2017-12-10', '2017-12-10');
INSERT INTO `lend_list` VALUES ('2015040148', '10000003', '11', '2017-12-10', '2017-12-10');
INSERT INTO `lend_list` VALUES ('2015040149', '10000001', '111', '2017-12-10', '2017-12-10');
INSERT INTO `lend_list` VALUES ('2015040150', '10000005', '11', '2017-12-10', null);
INSERT INTO `lend_list` VALUES ('2015040151', '10000001', '1', '2017-12-10', '2017-12-10');
INSERT INTO `lend_list` VALUES ('2015040152', '10000001', '111', '2017-12-10', '2017-12-10');
INSERT INTO `lend_list` VALUES ('2015040153', '10000001', '111', '2017-12-10', '2017-12-10');
INSERT INTO `lend_list` VALUES ('2015040154', '10000001', '111', '2017-12-10', '2017-12-10');
...
CREATE TABLE `reader_card` (
  ...
  `card_state` tinyint(4) NOT NULL DEFAULT '1',
...
-- ----------------------------
INSERT INTO `reader_card` VALUES ('111', '王呜呜', '111', '1');
...
-- ----------------------------
INSERT INTO `reader_info` VALUES ('111', '王呜呜', '女', '2017-12-28', '河北', '133131');
