    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><a href="jg1.html?jgId=<c:out value="${jg.jgId}"></c:out>"><button type="button" class="btn btn-success btn-xs">同意</button></a></td>
                <td><a href="jg2.html?jgId=<c:out value="${jg.jgId}"></c:out>"><button type="button" class="btn btn-success btn-xs">拒绝</button></a></td>
            </tr>
            </c:forEach>
            </tbody>
        </table>
